...
The [<span class="api">start</span>] API initialises the RTOS, makes all tasks runnable and then, based on the scheduling algorithm, chooses and starts executing the current task.
