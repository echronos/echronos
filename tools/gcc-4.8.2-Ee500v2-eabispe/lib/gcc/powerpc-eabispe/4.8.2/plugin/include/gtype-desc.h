...
#define ggc_alloc_vrp_info_type() ((union vrp_info_type *)(ggc_internal_alloc_stat (sizeof (union vrp_info_type) MEM_STAT_INFO)))
#define ggc_alloc_cleared_vrp_info_type() ((union vrp_info_type *)(ggc_internal_cleared_alloc_stat (sizeof (union vrp_info_type) MEM_STAT_INFO)))
#define ggc_alloc_vec_vrp_info_type(n) ((union vrp_info_type *)(ggc_internal_vec_alloc_stat (sizeof (union vrp_info_type), n MEM_STAT_INFO)))
#define ggc_alloc_cleared_vec_vrp_info_type(n) ((union vrp_info_type *)(ggc_internal_cleared_vec_alloc_stat (sizeof (union vrp_info_type), n MEM_STAT_INFO)))
